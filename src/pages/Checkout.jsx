            ...
            >
              <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                  <h2 className="md:text-2xl text-xl font-bold leading-7 text-gray-900">
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div className="sm:col-span-4">
                      <label
                        htmlFor="email"
                        className="block text-sm px-3 font-medium leading-6 text-gray-900"
                      >
                        Email address
                      </label>
                      <div className="mt-2">
            ...
            <div className="mx-auto  bg-white max-w-7xl px-2 sm:px-2 lg:px-4">
                  ...
                  <ul className="-my-6 divide-y divide-gray-200">
                    {cartData?.map((item) => (
                      <li className="flex py-6">
                        <div className="h-24 w-22 flex-shrink-0  overflow-hidden rounded-md border border-gray-200">
                          <img
                            src={item.image}
                            alt=""
              ...
              <div className="border-t border-gray-200 px-2 py-6 sm:px-2">
                <div className="flex justify-between my-2 text-base font-medium text-gray-900">
                  <p>Subtotal</p>
                  <p className='text-black'>$ {totalAmt}</p>
                </div>
                <div className="flex justify-between my-2 text-base font-medium text-gray-900">
